              ...
              >
                <div className="relative">
                  ...
                  >
                    ...
                    <Plus className="relative h-9 w-9 transition-transform group-hover:rotate-180 duration-500 text-primary" />
                  </Button>
                </div>
            ...
            {users.map((user, index) => (
              ...
              >
                <div className="relative">
                  ...
                  <div className={`w-[90px] h-[90px] rounded-full p-[3.5px] relative ${
                    ...
                    <div className="relative bg-background w-full h-full rounded-full flex items-center justify-center overflow-hidden border-[3px] border-background">
                      {user.avatarUrl ? (
                        ...
                        <span className="text-3xl font-bold bg-gradient-to-br from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent">
                  ...
                  {user.id === currentUser?.uid && user.hasUnseenStories && (
                    <motion.div 
                      className="absolute -bottom-1 -right-1 w-8 h-8 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full flex items-center justify-center border-[3px] border-background shadow-xl"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                ...
                <span className="text-xs mt-2.5 truncate max-w-[90px] text-center font-semibold text-foreground/60 group-hover:text-foreground group-hover:scale-105 transition-all duration-300">
